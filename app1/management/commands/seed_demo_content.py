...
from app1.models import Artigos, Comentario, Notificacao
...
NOTIFICATIONS = [
    {
        ...
        "resumo": "Música, gastronomia e economia criativa ocupam o Centro Histórico.",
        "imagem": "https://images.unsplash.com/photo-1505765050516-f72dcac9c60e?auto=format&fit=crop&w=800&q=80",
    },
    {
        "titulo": "Bal Masqué 2026 abre venda de ingressos",
        "categoria": "De seu interesse",
        "resumo": "Evento retorna com line-up de frevo, pop e fantasias premiadas.",
        "imagem": "https://images.unsplash.com/photo-1523800503107-5bc3ba2a6f81?auto=format&fit=crop&w=800&q=80",
    },
    {
        "titulo": "Bikini Memories estreia temporada de verão",
        "categoria": "De seu interesse",
        "resumo": "Programação de shows e festas movimenta o Litoral Sul.",
...
class Command(BaseCommand):
    help = "Popula o banco com notícias demo e um comentário de exemplo."
    ...
    def handle(self, *args, **options):
        ...
        # Comentário de demonstração para o artigo do Paço do Frevo, como no protótipo.
        frevo = Artigos.objects.filter(titulo__icontains="Paço do Frevo").first()
        if frevo and not frevo.comentarios.exists():
            Comentario.objects.create(
                artigo=frevo,
                nome="Carol Mendes",
                texto="Ótima matéria! O passo do frevo realmente faz um trabalho incrível.",
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"{created} artigos criados/atualizados; {notif_created} notificações criadas/atualizadas."
            )
        )
